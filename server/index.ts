...
const mediaUpload = async (req, res) => {
    try {
        console.log("mediaUpload receive request: " + JSON.stringify(req.session))
...
const mediaAccess = async (req, res) => {
    try {
        console.log("mediaAccess receive request: " + JSON.stringify(req.session))
        if (!req.session.session_id) {
...
const collectionList = async (req, res) => {
    try {
        console.log("collectionList receive request: " + JSON.stringify(req.session))
        if (!req.session.session_id) {
...
const collectionCreate = async (req, res) => {
    try {
        console.log("collectionCreate receive request: " + JSON.stringify(req.session))
        if (!req.session.session_id) {
...
const collectionDelete = async (req, res) => {
    try {
        console.log("collectionDelete receive request: " + JSON.stringify(req.session))
        if (!req.session.session_id) {
...
const connect = async (req, res) => {
    try {
        console.log("apiConnect receive request: " + JSON.stringify(req.session))
        if (!req.session.session_id) {
...
const op = async (req, res) => {
    try {
        console.log("apiOP receive request: " + JSON.stringify(req.session))
        if (!req.session.session_id) {
...
const presence = async (req, res) => {
    try {
        console.log("apiPresence receive request: " + JSON.stringify(req.session))
        if (!req.session.session_id) {
